var mymap = L.map('mapid').setView([34.6937378, 135.50216509999996], 13);
...
for (var i = 0; i < markerArray.length; i++) {
    var marker = L.marker([markerArray[i].lat, markerArray[i].lon]).addTo(mymap);
    marker.bindPopup("<span class=\"marker-title\">" + markerArray[i].title + "</span>");
    if (i === markerArray.length - 1)
        marker.openPopup();
}
var ourAirbnb = new L.LatLng(34.709302, 135.511568);
var nearestPark = new L.LatLng(34.703672, 135.509318);
var pointList = [ourAirbnb, nearestPark];
